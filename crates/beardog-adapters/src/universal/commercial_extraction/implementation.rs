...
impl CommercialExtractionDetector {
    ...
    pub async fn analyze_request(
        ...
        let key_evolution_status = self.check_key_evolution(&user_id).await;
    ...
    async fn check_key_evolution(&mut self, user_id: &str) -> KeyEvolutionStatus {
            ...
            if history.key_generations.is_empty() {
                ...
                if age
                    > self
                        ...
                        .generation_lifespan
                {
                    KeyEvolutionStatus::ReadyForEvolution
                } else {
                    KeyEvolutionStatus::Stable
                }
            }
        } else {
            KeyEvolutionStatus::Uninitialized
        }
    }
