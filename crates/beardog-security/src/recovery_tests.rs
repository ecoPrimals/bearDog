...
mod tests {
    ...
    #[tokio::test]
    fn test_federation_recovery_setup() {
        let provider = BearDogSecurityProvider::new(SecurityProviderConfig::default())
            .unwrap();
    ...
    #[tokio::test]
    fn test_ephemeral_recovery_key_generation() {
        let provider = BearDogSecurityProvider::new(SecurityProviderConfig::default())
            .unwrap();
    ...
    #[tokio::test]
    fn test_account_lockout_with_recovery() {
        ...
        let provider = BearDogSecurityProvider::new(config).unwrap();
    ...
    fn test_recovery_manager_creation() {
        let recovery_manager = RecoveryManager::new().unwrap();
    ...
    #[tokio::test]
    fn test_ephemeral_key_expiry_and_usage_limits() {
        let recovery_manager = RecoveryManager::new().unwrap();
    ...
    #[tokio::test]
    fn test_multi_party_recovery_concept() {
        let recovery_manager = RecoveryManager::new().unwrap();
