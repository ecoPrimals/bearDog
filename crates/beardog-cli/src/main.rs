...
mod commands;
use commands::{AiCommand, execute_ai_command};
...
#[command(long_about = "BearDog provides enterprise-grade security operations through AI-optimized APIs and CLI tools. All operations are machine-readable with JSON output, batch processing, and automation-friendly interfaces.")]
struct Cli {
    #[command(subcommand)]
    command: Commands,
