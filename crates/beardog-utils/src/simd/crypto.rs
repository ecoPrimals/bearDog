...
impl SimdCryptoAccelerator {
    ...
    pub fn safe_sha256(&self, input_buffer: &[u8]) -> Result<[u8; 32], BearDogError> {
        ...
        debug!("🔐 Safe SHA-beardog_types::constants::domains::system::DEFAULT_CACHE_SIZE / 2 for {} bytes", input_buffer.len());
    ...
    pub fn get_performance_metrics(&self) -> HashMap<String, f64> {
        ...
        if self.capabilities.has_aes_ni {
            metrics.insert("aes_throughput_mbps".to_string(), beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE as f64);
        } else {
    ...
    pub fn benchmark_operations(&self) -> Result<HashMap<String, u64>, BearDogError> {
        ...
        for _ in 0..beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE {
            let _ = self.safe_aes_encrypt(&test_data, &test_key)?;
        }
        let aes_duration = start.elapsed();
        results.insert(
            "aes_encrypt_ns_per_kb".to_string(),
            aes_duration.as_nanos() as u64 / beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE as u64,
        );
        ...
        results.insert(
            ...
            sha_duration.as_nanos() as u64 / beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE as u64,
        );
