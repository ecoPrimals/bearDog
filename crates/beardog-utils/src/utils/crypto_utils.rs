...
mod tests {
    ...
    fn test_hmac_sha256() {
        ...
        let data = b"hello world";
        let hmac = hmac_sha256(key, data).expect("HMAC should succeed with valid key");
    ...
    fn test_empty_data_handling() {
        ...
        let hmac = hmac_sha256(b"key", empty_data).expect("HMAC should succeed with empty data");
    ...
    fn test_large_data_handling() {
        ...
        let hmac = hmac_sha256(b"key", &large_data).expect("HMAC should succeed with large data");
