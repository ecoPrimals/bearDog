...
pub struct NotificationConfig {
    ...
    /// SMS phone number for notifications
    pub sms_phone_number: Option<String>,
    /// SMS from number for notifications
...
pub struct NotificationResult {
    ...
    pub email_sent: bool,
    /// Whether SMS notification was sent successfully
    pub sms_sent: bool,
    /// Whether webhook notification was sent successfully
    pub webhook_sent: bool,
    /// Whether Slack notification was sent successfully
    pub slack_sent: bool,
    /// Whether Teams notification was sent successfully
    pub teams_sent: bool,
    /// Error messages if any notifications failed
