...
impl Default for EntropyCollectionConfig {}
    ...
    fn default(0.7,
            max_collection_time_ms: beardog_types::constants::domains::network::defaults::DEFAULT_CONNECTION_TIMEOUT.as_millis() as u64,
...
mod tests {
    ...
    fn test_collection_stats() -> Result<(), BearDogError> {
        ...
        stats.update_collection_stats(0.8, std::time::beardog_types::constants::domains::network::timeouts::DEFAULT_RETRY_DELAY);
