...
mod integration_tests {
    ...
    #[tokio::test]
    async fn test_complete_hsm_discovery_workflow() {
        ...
        let mut discovery = UniversalHsmDiscovery::new()
            .expect("Failed to initialize Universal HSM Discovery System");
    ...
    async fn test_human_entropy_classification_pipeline() {
        ...
        for (name, capabilities) in test_cases {
            let assessment = classifier
                ...
                .await
                .expect("Failed to assess human entropy capabilities");
    ...
    #[tokio::test]
    async fn test_multi_hsm_operation_scenarios() {
        ...
        let tier_manager = tier_manager::TierManager::new().expect("Failed to create tier manager");
