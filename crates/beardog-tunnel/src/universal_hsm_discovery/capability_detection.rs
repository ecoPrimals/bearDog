...
/// Returns an error if the operation fails.
    ...
    fn create_default_hsm_capabilities(
        ...
        Ok(beardog_types::HsmCapabilities {
            ...
            max_keys: Some(beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE),
            ...
            key_generation:
                beardog_types::canonical::hsm::capabilities::KeyGenerationCapabilities {
                    ...
                    supported_key_sizes: vec![2048, beardog_types::constants::domains::system::defaults::DEFAULT_BUFFER_SIZE],
