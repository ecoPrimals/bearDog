...
pub fn create_default_software_hsm(format!("{:?}", SoftwareHsmType::RustSoftwareHsm),
        ...
        max_cached_keys: beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE,
        key_storage: KeyStoreConfig {
            storage_type: KeyStorageType::Database,
            encryption_key_source: KeySource::Derived,
            backup_enabled: true,
            cache_size: beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE,
            file_config: None,
...
/// Returns an error if the operation fails.
    ...
    Ok(vec![
            ...
            KeyType::Rsa { key_size: beardog_types::constants::domains::system::defaults::DEFAULT_BUFFER_SIZE },
        ],
        ...
        supported_storage_backends: get_supported_storage_backends(beardog_types::constants::domains::system::defaults::DEFAULT_BUFFER_SIZE,
