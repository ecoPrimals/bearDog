...
/// `KeyProperties.SECURITY_LEVEL_STRONGBOX`. Fails closed until the native
/// bridge is available — use `BEARDOG_ANDROID_STRONGBOX_AVAILABLE=true` to
/// override for validated devices.
#[cfg(target_os = "android")]
