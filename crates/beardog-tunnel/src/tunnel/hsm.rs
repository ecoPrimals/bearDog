...
// MIGRATED: Export canonical unified provider traits
pub use beardog_types::canonical::providers_unified::traits::HsmProvider;
...
impl Default for PerformanceRequirements {
    fn default() -> Self {
        Self {
            max_latency_ms: Some(beardog_types::constants::domains::system::defaults::DEFAULT_QUEUE_SIZE),           // 1 second default
