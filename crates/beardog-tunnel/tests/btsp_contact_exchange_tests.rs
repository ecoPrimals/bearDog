...
async fn test_contact_info_serialization() {
    ...
    let contact = ContactInfo {
        ...
        addresses: vec!["192.168.1.5:10000".to_string(), "10.0.0.3:10001".to_string()],
...
async fn test_contact_exchange_max_hops() {
    ...
    let result1 = provider.contact_exchange("unknown_peer", "test_lineage", 1).await;
    let result2 = provider.contact_exchange("unknown_peer", "test_lineage", 10).await;
