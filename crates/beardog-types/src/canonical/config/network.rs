...
impl Default for ServicePorts {
    fn default() -> Self {
        use beardog_config::domains::network_ports::{
            ...
            DEFAULT_DATABASE_PORT, DEFAULT_DEBUG_PORT, DEFAULT_DISCOVERY_PORT,
            DEFAULT_GRAFANA_PORT, DEFAULT_HEALTH_PORT, DEFAULT_JAEGER_PORT, DEFAULT_MESH_PORT,
            DEFAULT_METRICS_PORT, DEFAULT_SECURITY_PORT, DEFAULT_STORAGE_PORT,
