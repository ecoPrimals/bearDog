...
mod tests {
    ...
    fn test_load_from_file_missing() {
        let err =
            UnifiedConfigUtils::load_from_file::<TestConfig, _>("/nonexistent/beardog.cfg.toml")
                .unwrap_err();
    ...
    fn test_load_with_fallback_all_missing() {
        let err = UnifiedConfigUtils::load_with_fallback::<TestConfig>(
            "/nope/nope.toml",
            &["/nope2.toml"],
        )
        .unwrap_err();
    ...
    fn test_find_and_auto_load_with_temp_config() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let err = UnifiedConfigUtils::auto_load_config::<TestConfig>("unlikely_app_xyz_12345")
            .unwrap_err();
