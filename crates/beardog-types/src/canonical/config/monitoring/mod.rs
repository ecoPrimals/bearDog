...
pub struct RateLimitConfig {
    ...
    /// Number of `max_notifications_per_minute`
    pub max_notifications_per_minute: u32,
    /// Max Notifications Per Hour
    /// Number of `max_notifications_per_hour`
    pub max_notifications_per_hour: u32,
    /// Burst Limit
    /// Number of `burst_limit`
    pub burst_limit: u32,
}
...
impl MonitoringConfigValidation for UnifiedMonitoringConfig {
    /// Validates input
    fn validate(&self) -> Result<(), BearDogError> {
