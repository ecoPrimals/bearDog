...
pub async fn authenticate_user(
    ...
    beardog_errors::BearDogError::internal(format_args!("Operation failed ({}): {:?}", "BEARDOG_ADMIN_PASSWORD environment variable must be set for security", e).to_string())
})?;
...
mod tests {
    ...
    beardog_errors::BearDogError::internal(format_args!("Operation failed ({}): {:?}", "Serialization failed", e).to_string())
