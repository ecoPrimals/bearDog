// Removed unused imports - tests use expect() for simplicity
...
mod auth_tests {
    ...
    async fn test_session_validation() {
        ...
        let session_data = create_session_data(user_id, session_id)
            .await
    ...
    async fn test_decentralized_auth_token_operations() {
        // Simplified test - DecentralizedAuthManager temporarily disabled in beardog-security
    ...
    async fn verify_password(
        ...
        // PasswordVerifier already imported above
        let parsed_hash =
