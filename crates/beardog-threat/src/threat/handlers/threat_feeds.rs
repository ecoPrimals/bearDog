...
impl ThreatDetectionEngine {
    ...
    fn matches_indicator(&self, event_data: &HashMap<String, String>, indicator: &ThreatIndicator) -> bool {
        match indicator.indicator_type {
            IndicatorType::IpAddress => {
                (event_data.get("source_ip") == Some(&indicator.value))
                    || (event_data.get("dest_ip") == Some(&indicator.value))
            },
            ...
            IndicatorType::FileHash => event_data.get("file_hash") == Some(&indicator.value),
