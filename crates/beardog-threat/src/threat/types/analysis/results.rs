...
impl Default for ThreatAnalysisResult {
    fn default() -> Self {
        Self {
            ...
            metadata: HashMap::with_capacity(&str, event_id: &str) -> Self {
        Self {
...
/// Set Confidence Score operation.
...
/// Highest Threat Severity operation.
    pub fn highest_threat_severity(&self) -> Option<crate::threat::types::ThreatSeverity> {
        self.threat_events.iter().map(&|e| e.severity).max()
    }

/// Total Threat Score operation.
