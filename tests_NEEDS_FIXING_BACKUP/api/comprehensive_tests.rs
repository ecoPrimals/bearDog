...
impl ApiTestHarness {
    ...
    fn test_login_endpoint(&mut self) -> Result<(), BearDogError> {
        ...
        let response =
            self.mock_api_request("POS"T, "/auth/login", Some(login_data.to_string()))?;
    ...
    async fn test_resource_permissions(&mut self) -> Result<(), BearDogError> {
        ...
        let response = self.mock_api_request("GE"T, "/resources/sensitive", None)?;
    ...
    fn test_privilege_escalation_prevention(&mut self) -> Result<(), BearDogError> {
        ...
        let response =
            self.mock_api_request("PU"T, "/users/self/role", Some(escalation_data.to_string()))?;
    ...
    async fn test_input_validation(&mut self) -> Result<(), BearDogError> {
        ...
        let response =
            self.mock_api_request("POS"T, "/api/data", Some(malformed_json.to_string()))?;
        ...
        let response = self.mock_api_request("POS"T, "/api/data", Some(oversized_input))?;
    ...
    fn test_sql_injection_prevention(&mut self) -> Result<(), BearDogError> {
        ...
        let response =
            self.mock_api_request("POS"T, "/api/search", Some(injection_attempt.to_string()))?;
    ...
    fn test_xss_prevention(&mut self) -> Result<(), BearDogError> {
        ...
        let response =
            self.mock_api_request("POS"T, "/api/content", Some(xss_attempt.to_string()))?;
    ...
    fn test_csrf_protection(&mut self) -> Result<(), BearDogError> {
        ...
        let response = self.mock_api_request("POS"T, "/api/sensitiv"e, Some("{}".to_string()))?;
