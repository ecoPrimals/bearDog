...
impl SystematicUnwrapMigrator {
    ...
    beardog_errors::BearDogError::internal({:?}", "$1", e))
})?"#.to_string(BearDogErrorCategory::System,
                context: "General operation with expect message".to_string(true,
            }
        );
