...
//! Test Metrics Collection and Analysis for BearDog
//!
//! **Advanced Performance Monitoring for Test Infrastructure**
//!
//! This module provides sophisticated metrics collection, analysis, and reporting
//! capabilities for BearDog's testing infrastructure, enabling performance
//! optimization and quality insights.
...
pub struct TestMetricsCollector {
    ...
    /// Performance benchmarks by test
...
/// Performance benchmark for a specific test
#[derive(Debug, Clone)]
...
impl TestMetricsCollector {
    ...
    pub fn new(config: MetricsConfig) -> Self {
        Self {
            ...
            performance_benchmarks: Arc::new(RwLock::new(HashMap::new())),
    ...
    pub async fn detect_regressions(&self, test_name: &str) -> TestResult<Vec<PerformanceRegression>> {
        ...
        // Compare recent performance to baseline (average of earlier benchmarks)
    ...
    async fn update_quality_metrics(&self, record: &TestExecutionRecord) -> TestResult<()> {
        ...
        // Update stability score for the test
    ...
    async fn generate_performance_analysis(&self, _cutoff_time: SystemTime) -> TestResult<PerformanceAnalysis> {
        // This would analyze performance benchmarks to identify fastest/slowest tests,
    ...
    async fn generate_quality_analysis(&self, _cutoff_time: SystemTime) -> TestResult<QualityAnalysis> {
        ...
        // Find most reliable tests (highest stability scores)
    ...
    format!("Operation failed: {:?}", e)
        ...
        // Find flakiest tests (lowest stability scores)
    ...
    async fn generate_recommendations(
        ...
        if execution.success_rate < 95.0 {
            recommendations.push(MetricsRecommendation {
                ...
                description: format!("Current success rate is {:.1}%, below the target of 95%", execution.success_rate),
        ...
        if !quality.flakiest_tests.is_empty() {
            recommendations.push(MetricsRecommendation {
                ...
                description: format!("Found {} flaky tests that need attention", quality.flakiest_tests.len()),
                affected_tests: quality.flakiest_tests.clone(),
...
/// Utility function to create environment info
