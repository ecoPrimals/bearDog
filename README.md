...
**Status**: Production Ready | **Edition**: 2024 | **MSRV**: 1.93.0 | **Crates**: 29 | **JSON-RPC Methods**: 226 | **Tests**: 13,857+ | **Coverage**: 90.51% | **Last Updated**: June 21, 2026
...
| **Rust files** | 2,125 |
| **Tests** | 14,974+ (concurrent; 35 `#[serial]` in `beardog-production`) |
