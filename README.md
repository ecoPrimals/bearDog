...
**Status**: Production Ready | **Edition**: 2024 | **MSRV**: 1.93.0 | **Crates**: 30 | **Tests**: 14,387 | **Coverage**: 87.2%+
...
| **Tests** | 14,387 (fully concurrent, zero sleeps in non-chaos) |
| **Coverage** | 87.2%+ line (llvm-cov workspace) |
