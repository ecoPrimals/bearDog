...
**Status**: Production Ready | **Edition**: 2024 | **MSRV**: 1.93.0 | **Crates**: 29 | **JSON-RPC Methods**: 117 | **Tests**: 12,610 | **Coverage**: 90.51% | **Last Updated**: May 8, 2026
...
| **Rust files** | 2,150 |
| **Tests** | 12,610 (concurrent; 35 `#[serial]` in `beardog-production`) |
