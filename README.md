...
**Status**: Production Ready | **Edition**: 2024 | **MSRV**: 1.93.0 | **Crates**: 29 | **Tests**: 14,925+ | **Coverage**: 90.51% | **Last Updated**: April 22, 2026
...
| **Rust files** | 2,150 |
| **Tests** | 14,925+ (concurrent; 35 `#[serial]` in `beardog-production`) |
