...
**Status**: Production Ready | **Edition**: 2024 | **MSRV**: 1.93.0 | **Crates**: 29 | **JSON-RPC Methods**: 225 | **Tests**: 14,987+ | **Coverage**: 90.51% | **Last Updated**: Jun 4, 2026
...
- **225 JSON-RPC Methods** — Complete crypto API (BTSP handshake-as-a-service, ionic bond lifecycle, contract signing, lineage queries, consent gate, FIDO2/CTAP2 hardware authentication)
...
| **Rust files** | 2,115 |
| **Tests** | 14,988+ (concurrent; 35 `#[serial]` in `beardog-production`) |
