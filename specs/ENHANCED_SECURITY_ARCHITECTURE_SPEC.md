---
description: ENFORCE universal security architecture with decentralized encryption and zero-trust networking
globs: ["beardog/src/**/*.rs", "beardog/crates/**/*.rs"]
---

# Enhanced Security Architecture Specification

## Context
- When implementing universal security coordination
- When providing decentralized encryption services
- When managing zero-trust networking protocols
- When integrating with ecosystem-wide security policies

## Requirements

### Universal Security Services
- Implement decentralized security architecture
- Support multiple encryption protocols simultaneously
- Enable dynamic security policy enforcement
- Provide universal authentication and authorization

### Zero-Trust Networking
- Implement comprehensive network security
- Support mutual authentication for all communications
