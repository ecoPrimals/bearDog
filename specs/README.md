...
**Crates**: 30 | **Tests**: 12,300+ | **Coverage**: 78.6%
...
| Tests | 12,300+ passing | 30 crates, 100% pass rate |
| Coverage | 78.6% | 9 crates above 90% target |
...
Specs from 2025 (October-December) are preserved for historical reference. Many metrics from that era (4% coverage, 22 crates, 435 tests) are now vastly outdated. Current metrics are in [STATUS.md](../STATUS.md).
