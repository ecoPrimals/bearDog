...
**Crates**: 30 | **Tests**: 14,351 passing | **Coverage**: 87.0%+ (llvm-cov line coverage)
...
| Tests | 14,351 passing | 30 crates, 100% pass rate |
| Coverage | 87.0% (llvm-cov) | 9 crates above 90% target |
...
Specs from 2025 (October-December) are preserved for historical reference. Many metrics from that era (4% coverage, 22 crates, 435 tests) are now vastly outdated. Current metrics are in [STATUS.md](../STATUS.md) (14,351 tests, 87.0%+ line coverage as of March 24, 2026).
