...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("🎉 BearDog maintains full sovereignty while leveraging network effects");
...
async fn demo_ecosystem_registration() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("✅ Registration successful: {}", response.success);
    info!("   📊 Processing time: {}ms", response.meta.processing_time_ms);
...
async fn demo_service_discovery() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("   • ToadStool: Universal Compute Platform (30% load)");
    info!("   • Songbird: AI-Collaborative Service Mesh (60% load)");
    info!("   • NestGate: Enterprise Storage with ZFS (40% load)"); 
    info!("   • Squirrel: AI Coordination & Analysis (20% load)");
    ...
    info!("✅ Discovery complete: {} active services", 5);
    info!("   🌡️ Network health: Excellent"); 
    info!("   ⚡ Total capabilities: 15");
...
async fn demo_security_service_provision() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("🔬 Analyzing ToadStool compute requests...");
    ...
    info!("   • GDPR Compliance: ✅ COMPLIANT");
    info!("   • Data Sovereignty: ✅ VERIFIED");
    ...
    info!("✅ Security services provided successfully");
...
async fn demo_toadstool_compute_request() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("🧬 Requesting compute for genetic spawning:");
    ...
    info!("✅ ToadStool compute allocated:");
    ...
    info!("🚀 Genetic spawning computation starting on ToadStool...");
...
async fn demo_squirrel_ai_assistance() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("🎯 AI recommendations received:");
    ...
    info!("   • 🔒 Privacy: Fully preserved");
    info!("   • 📊 Data Harvesting: None");
    ...
    info!("✅ AI coordination successful");
    info!("   🤝 Squirrel enhanced BearDog capabilities while preserving sovereignty");
...
async fn demo_nestgate_storage() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("✅ NestGate storage allocated:");
...
async fn demo_network_effects_analytics() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("   • Compute Hours: 240 (from ToadStool)");
    info!("   • AI Optimizations: 12 (from Squirrel)");
    info!("   • Storage: 500GB (from NestGate)");
