...
mod usage_examples {
    ...
    fn production_from_file(config_path: &str) -> Result<ResourceLimits, Box<dyn std::error::Error>> {
    ...
    fn production_mixed() -> ResourceLimits {
        ...
        production_from_file("config.json")
            .unwrap_or_else(|_| ResourceLimits::from_env())
    }
}
