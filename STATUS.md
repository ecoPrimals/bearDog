...
**Last Updated**: July 18, 2026 (Wave 149b)
**Version**: 0.9.0
...
| **Tests** | 13,884+ passing | Concurrent; 35 `#[serial]` in `beardog-production` (shared `AtomicBool`) |
...
- **Rust Files**: 2,110 (crates + src + tests; excludes showcase/examples)
